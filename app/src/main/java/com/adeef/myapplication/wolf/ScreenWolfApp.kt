package com.adeef.myapplication.wolf
...
import com.adeef.myapplication.wolf.data.Dog
import com.adeef.myapplication.wolf.data.dogs
import com.adeef.myapplication.wolf.theme.WoofTheme

@Composable
fun ScreenWolfApp(modifier: Modifier = Modifier) {
    Scaffold(
        topBar = {
            WoofTopAppBar()
        }
